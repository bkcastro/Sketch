...
Sketchbook makes use of a process called [ZettelKasten](https://en.wikipedia.org/wiki/Zettelkasten) invented by [Nkilas Luhman](https://en.wikipedia.org/wiki/Niklas_Luhmann). But instead of taking notes we create **sketches**. 
